                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-header d-flex align-items-center">
                                <h3 class="h4">Add new Banner</h3>
                            </div>
                            <div class="card-body">
                                @include('admin.layout.AlertFile')
                                <p>Banner will belong to a mother category.</p>
                                <form action="admin/Banner/AddBanner" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">Chose a image</label>
                                        <div class="col-sm-9">
