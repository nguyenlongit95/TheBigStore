                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add new main categories, main categories has created this created new Banner and Categories.</p>
                                <form action="admin/Categories/AddMainCategories" method="POST" class="form-horizontal">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">Name Main Categories</label>
                                        <div class="col-sm-9">
                                            <input id="inputHorizontalSuccess" type="text" name="MainCategories" placeholder="Add New Main Categories" class="form-control form-control-success"><small class="form-text">Main Categories has mother of Categories.</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
